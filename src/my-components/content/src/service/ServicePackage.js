...
export default function ServicePackage({pk, title, description, fee, subscription_duration, subscribed, canSubscribe, subscriptionHandler, userType}){
    ...
    <>
        <div className="card service-provider-card">
            ...
            {canSubscribe &&
                <>
                {subscribed &&
                    <div className='text-center'><a className="btn mb-0 mybutton btn-block" onClick={subscriptionHandler}>unsubscribe</a></div>
                }
                {!subscribed &&
                    <div className='text-center'><a className="btn mb-0 mybutton btn-block" onClick={subscriptionHandler}>subscribe</a></div>
                }
                </>
            }
        </div>
