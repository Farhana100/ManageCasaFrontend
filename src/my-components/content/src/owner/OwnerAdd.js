...
export default function OwnerAdd(){
    ...
    function fetchAllApartment(){
        fetch(`http://127.0.0.1:8000/getAllApartmentsWithoutOwners/${user.building}`)
    ...
    async function createOwnerHandler(e){
        e.preventDefault();
        if(password !== "" && confirmPassword !== password){
            ...
            await axios({
                method: 'post', 
                url: "http://127.0.0.1:8000/createOwner",
                data: formData
            })
            .then(response => {
                ...
                <div className='col-7'>
                    <form className='container'>
                        ...
                        <div className='form-group row my-5'>
                            <div className='col d-flex justify-content-start'><Button text={'Cancel'} link={'/owners'} /></div>
                            <div className='col d-flex justify-content-end'><Button text={'Submit'} OnClick={createOwnerHandler}/></div>
                        </div>
                    </form>
                </div>
                    ...
                    <div className="text-left">
                        {   apartmentData
                            ...
                            <div className='container-fluid mt-5 pl-0'>
                                ...
                                {apartmentData['tenant'] !== 'None' &&
                                    <div className='row'>
                                        <div className='col'><strong>Tenant: </strong></div>
                                        <div className='col'>{apartmentData['tenant']}</div>
                                    </div>
                                }
